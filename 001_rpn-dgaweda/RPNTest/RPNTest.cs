...
namespace RPNTest {
	...
	public class RPNTest {
		...
		[TestCase(99, 99)]
		[TestCase(0, 0)]
		[TestCase(-2019923, 2019923)]
		public void AbsoluteValue(int value, int expected) {
			var result = _sut.EvalRPN($"{value} |");
		...
		public void DivideByZero() {
			Assert.Throws<DivideByZeroException>(() => _sut.EvalRPN("0 3 /"));
		}
	}
}